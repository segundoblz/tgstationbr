/datum/escape_menu/proc/show_home_page()
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Resume"),
			/* offset = */ list(-136, 30),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Character"),
			/* offset = */ list(-171, 28),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Settings"),
			/* offset = */ list(-206, 30),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable/admin_ticket_notification(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Admin Help"),
			/* offset = */ list(-241, 30),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable/leave_body(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Leave Body"),
			/* offset = */ list(-276, 30),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(
		new /atom/movable/screen/escape_menu/text/clickable(
			...
			/* hud_owner = */ null,
			/* escape_menu = */ src,
			/* button_text = */ client_T(client, "Quit"),
			/* offset = */ list(-311, 30),
			/* font_size = */ 24,
	...
	page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small(
		null,
		/* hud_owner = */ null,
		client_T(client, "Resources"),
		client_T(client, "Open/Close list of resources"),
...
/datum/escape_menu/proc/toggle_resources()
	...
	if(githuburl)
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			null,
			/* hud_owner = */ null,
			client_T(client, "Report Bug"),
			client_T(client, "Report a bug/issue"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
		...
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			...
			/* hud_owner = */ null,
			"Github",
			client_T(client, "Open the repository for the game"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
	...
	if(forumurl)
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			...
			/* hud_owner = */ null,
			"Forums",
			client_T(client, "Visit the server's forums"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
	...
	if(rulesurl)
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			null,
			/* hud_owner = */ null,
			client_T(client, "Rules"),
			client_T(client, "View the server rules"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
	...
	if(wikiurl)
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			...
			/* hud_owner = */ null,
			"Wiki",
			client_T(client, "See the wiki for the game"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
	...
	if(configurl)
		resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
			null,
			/* hud_owner = */ null,
			client_T(client, "Config"),
			client_T(client, "View the server configuration files"),
			/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
	...
	resource_panels += page_holder.give_screen_object(new /atom/movable/screen/escape_menu/lobby_button/small/collapsible(
		null,
		/* hud_owner = */ null,
		client_T(client, "Change Log"),
		client_T(client, "See all changes to the server"),
		/* button_screen_loc */ "BOTTOM:30,RIGHT:-20",
