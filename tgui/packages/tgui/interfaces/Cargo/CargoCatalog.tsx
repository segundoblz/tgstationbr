      ...
      <Stack.Item>
        {!express && (
          <Button
            ...
            tooltip={t('Use your own funds to purchase items.')}
            tooltipPosition="top"
          >
            {t('Buy Privately')}
          </Button>
            ...
            <Stack fill textAlign="right">
              ...
              {(!!pack.small_item || !!pack.access || !!pack.contraband) && (
                <Stack.Item>
                  <Stack reverse>
                    {!!pack.small_item &&
                      tooltipIcon(t('Small Item'), 'compress-alt', 'purple')}
                    {!!pack.access &&
                      tooltipIcon(t('Restricted'), 'lock', 'average')}
                    {!!pack.contraband &&
                      tooltipIcon(t('Contraband'), 'pastafarianism', 'bad')}
                  </Stack>
                </Stack.Item>
              )}
    ...
    <Modal p={1} width="50vw" height="50vh">
      <Stack fill vertical>
        <Stack.Item>
          ...
          >
            <BlockQuote>{pack?.desc || t('No description available.')}</BlockQuote>
          </Section>
        </Stack.Item>
        <Stack.Item m={0} grow>
          <Section fill scrollable>
            {contains && contains.length > 0 ? (
              ...
              <Stack fill vertical align="center" justify="center">
                ...
                <Stack.Item mt={2} color="label" textAlign="center">
                  {t(
                    "We can't find information about even the approximate contents of this order.",
                  )}
                </Stack.Item>
              </Stack>
            )}
